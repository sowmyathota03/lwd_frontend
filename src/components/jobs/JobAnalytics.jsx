      ...
      >
        ...
        >
          <div className="space-y-2">
            ...
            <h1 className="lwd-h2 leading-tight">{job.title}</h1>
            <p className="flex items-center gap-2 text-sm font-medium text-slate-500">
              <Building size={16} /> {job.company?.companyName}{" "}
              <span className="text-slate-300">•</span> <MapPin size={16} />{" "}
              {job.location}
            </p>
          </div>
      ...
      `}
        ...
        >
          <div className="lwd-card p-6 bg-blue-50 dark:bg-blue-900/10 border-blue-100 dark:border-blue-900/20 flex flex-col justify-between">
            ...
            <p className="text-4xl font-extrabold text-slate-900 dark:text-white tracking-tight leading-none">
              {totalApplications}
            </p>
          </div>
          ...
          {Object.entries(statusCounts).map(([status, count]) => (
            <div
              key={status}
              className="lwd-card p-6 flex flex-col justify-between"
            >
        ...
        <motion.div
          variants={itemVariants}
          className="lwd-card p-8 overflow-hidden"
        >
          <div className="flex items-center gap-3 mb-8 pb-6 border-b border-slate-100 dark:border-slate-800">
            ...
            <div>
              ...
              <p className="text-xs font-medium text-slate-400 mt-0.5">
                Summary of position parameters
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-xs font-medium text-slate-400">
                All candidates who applied for this listing
              </p>
            </div>
          </div>
