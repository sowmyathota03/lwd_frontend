    ...
    <div className="min-h-screen bg-gray-100 py-10 flex justify-center">
      <form onSubmit={handleSubmit} className="w-full max-w-6xl space-y-8">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm">
          <h2 className="text-lg font-semibold mb-5 text-gray-700">Job Details</h2>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm">
          <h2 className="text-lg font-semibold mb-5 text-gray-700">Application Settings</h2>
          <div className="grid md:grid-cols-3 gap-5">
            <Select
        ...
        <div className="bg-gray-50 p-6 rounded-xl shadow-sm">
          <h2 className="text-lg font-semibold mb-5 text-gray-700">Candidate Preference</h2>
          <div className="grid md:grid-cols-3 gap-5">
            ...
            />
            <Input label="Age Limit" name="ageLimit" value={job.ageLimit} handleChange={handleChange} type="number" />
          </div>
        </div>

        {/* ================= JOB DESCRIPTION ================= */}
        <div className="bg-white p-6 rounded-xl shadow-sm">
          <h2 className="text-lg font-semibold mb-5 text-gray-700">Job Description</h2>
