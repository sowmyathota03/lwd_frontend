...
const UserRow = React.memo(({ user, isLoading, openConfirm }) => {
  ...
  const roleColors = {
    ADMIN:
      "text-blue-600 bg-blue-50 dark:bg-blue-900/20 border-blue-100 dark:border-blue-800/50",
    COMPANY_ADMIN:
      "text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20 border-indigo-100 dark:border-indigo-800/50",
    RECRUITER:
      "text-violet-600 bg-violet-50 dark:bg-violet-900/20 border-violet-100 dark:border-violet-800/50",
    JOB_SEEKER:
      "text-slate-600 bg-slate-50 dark:bg-slate-900/20 border-slate-100 dark:border-slate-800/50",
  };
  ...
  return (
    <tr className="group/row hover:bg-blue-50/30 dark:hover:bg-blue-900/10 transition-all cursor-default">
      ...
      <td className="px-6 py-5">
        <div
          className={`inline-flex px-2 py-0.5 rounded-lg text-[10px] font-black uppercase tracking-widest border ${
            roleColors[user.role] || "text-slate-400 border-slate-200"
          }`}
        >
