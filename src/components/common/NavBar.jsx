      ...
      <header className="sticky top-0 z-50 bg-white shadow-md">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center gap-4">
             ...
             no-underline! hover:no-underline!"
                ...
                <>
                  {/* User Email */}
                  <span className="text-gray-700 font-medium truncate max-w-35">
                    {user?.sub}
                  </span>
                  ...
                  <Link
                   ...
                   transition duration-200 no-underline! hover:no-underline"
                  >
                    Profile
                  </Link>
        ...
        {isOpen && (
          <div className="md:hidden bg-white border-t px-6 py-4 space-y-4 shadow">
            <NavLink to="/" end className="block text-gray-700">
              Home
            </NavLink>
            <NavLink to="/jobs" className="block text-gray-700">
              Jobs
            </NavLink>
            <NavLink to="/companies" className="block text-gray-700">
              Companies
            </NavLink>
            <NavLink to="/career" className="block text-gray-700">
              Careers
            </NavLink>
