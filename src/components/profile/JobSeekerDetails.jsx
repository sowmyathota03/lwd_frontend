    ...
    >
      {!editing ? (
        <>
          ...
          <Grid>
            <Field label="Notice Status" value={profile?.noticeStatus?.replaceAll("_", " ")} />
            ...
            <Field label="Serving Notice" value={profile?.isServingNotice ? "Yes" : "No"} />
            <Field label="Immediate Joiner" value={profile?.immediateJoiner ? "Yes" : "No"} />
          </Grid>
        ...
        <>
          ...
          <Grid>
            <Input label="Notice Status" name="noticeStatus" value={formData.noticeStatus || ""} onChange={handleChange} />
            <Input label="Notice Period (Days)" name="noticePeriod" value={formData.noticePeriod || ""} onChange={handleChange} />
            <Input type="date" label="Last Working Day" name="lastWorkingDay" value={formData.lastWorkingDay || ""} onChange={handleChange} />
            <Input type="date" label="Available From" name="availableFrom" value={formData.availableFrom || ""} onChange={handleChange} />
          </Grid>
          ...
          <Grid>
            ...
            <Input label="Total Experience" name="totalExperience" value={formData.totalExperience || ""} onChange={handleChange} />
            <Input label="Current CTC" name="currentCTC" value={formData.currentCTC || ""} onChange={handleChange} />
            <Input label="Expected CTC" name="expectedCTC" value={formData.expectedCTC || ""} onChange={handleChange} />
