  ...
  return (
    <div className="lwd-card space-y-4">
      ...
      <div className="flex justify-between items-center">
        <h2 className="lwd-title">GitHub</h2>

        {editable && (
          <button
            onClick={() => setEditing(true)}
            className="lwd-btn-secondary flex items-center gap-2 text-sm px-3 py-1.5"
          >
            Edit
          </button>
        )}
      ...
      {url ? (
        <a
          ...
          className="lwd-link flex items-center gap-2 text-sm break-all"
        >
          {/* GitHub Icon */}
        ...
        <p className="lwd-text">
          {editable
            ? "No GitHub profile added. Click edit to add one."
