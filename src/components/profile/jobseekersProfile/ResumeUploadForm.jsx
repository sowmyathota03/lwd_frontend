...
/**
 * ResumeUploadForm component – modal for uploading a new resume.
 *
 * @param {Object} props
 ...
 */
function ResumeUploadForm({ currentFile, onClose, onSave }) {
    ...
    >
      ...
      >
        ...
        <div className="p-6 space-y-5">
          ...
          {/* Current file info */}
          {currentFile && (
            <div className="bg-gray-50 p-3 rounded-lg text-sm text-gray-700 flex items-center gap-2">
          ...
          <div>
            ...
            />
            {/* Format info */}
            <p className="text-gray-500 text-xs">Allowed formats: .pdf, .doc, .docx</p>
          </div>
