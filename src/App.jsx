...
import RegisterCompanyAdmin from "./auth/RegisterCompanyAdmin";
import VerifyEmail from "./auth/VerifyEmailPage";
...
import RecruiterAdminDashboard from "./pages/company-admin/RecruiterAdminDashboard";
import RecruiterAdminHome from "./components/company-admin/RecruiterAdminHome";
import RecruiterList from "./components/company-admin/RecruiterList";
...
import RecruiterOnboardingPage from "./components/recruiter/RecruiterOnboardingPage";
import SearchCompaniesPage from "./components/recruiter/SearchCompaniesPage";
import CompanyDetailsPage from "./components/recruiter/CompanyDetailsPage";
...
import RecruiterAdminPlans from "./pages/pricing/RecruiterAdminPlans";
...
import CompanyPendingPage from "./components/company/CompanyPendingPage";
import CompanyRejectedPage from "./components/company/CompanyRejectedPage";
import CompanySuspendedPage from "./components/company/CompanySuspendedPage";
import CompanyAdminRouteGuard from "./components/company/CompanyAdminRouteGuard";

import RecruiterBaseRoute from "./routes/RecruiterBaseRoute";
import RecruiterCompanyRequiredRoute from "./routes/RecruiterCompanyRequiredRoute";
  ...
  return (
    <div className="lwd-page flex min-h-[60vh] items-center justify-center px-4">
      <div className="lwd-card max-w-md text-center">
        <h1 className="mb-2 text-2xl font-bold text-red-600">Unauthorized</h1>
    ...
    <>
      ...
      <Routes>
        ...
        <Route element={<PrivateRoute allowedRoles={["COMPANY_ADMIN"]} />}>
          <Route
            path="/plans/company-admin"
            element={<RecruiterAdminPlans />}
          />
        </Route>
        ...
        <Route element={<PrivateRoute allowedRoles={["ADMIN"]} />}>
          <Route path="/admin" element={<AdminDashboard />}>
            ...
            <Route
              path="managejob/:jobId/analytics"
        ...
        <Route
          ...
          element={
            <PrivateRoute allowedRoles={["COMPANY_ADMIN"]}>
              <CompanyAdminRouteGuard />
            </PrivateRoute>
          }
        >
          <Route index element={<CompanyOnboardingGate />} />
          <Route path="setup" element={<CompanySetupPage />} />
          <Route path="pending" element={<CompanyPendingPage />} />
          <Route path="rejected" element={<CompanyRejectedPage />} />
          <Route path="suspended" element={<CompanySuspendedPage />} />
        </Route>
        ...
        <Route element={<PrivateRoute allowedRoles={["COMPANY_ADMIN"]} />}>
          ...
          >
            ...
            <Route path="dashboard" element={<RecruiterAdminHome />} />
        ...
        <Route element={<RecruiterBaseRoute />}>
          <Route
            path="/recruiter/onboarding"
            element={<RecruiterOnboardingPage />}
          />
          <Route
          ...
          />
          <Route
            path="/recruiter/company-requests"
            element={<RecruiterCompanyRequest />}
          />
        </Route>

        {/* RECRUITER FULL DASHBOARD ACCESS */}
        <Route element={<RecruiterCompanyRequiredRoute />}>
