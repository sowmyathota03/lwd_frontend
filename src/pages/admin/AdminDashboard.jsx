  ...
  return (
    <div className="flex h-screen w-full bg-linear-to-br from-slate-300 via-blue-400 to-indigo-600 transition-all duration-500">
        ...
        <nav className="flex-1 p-2 space-y-3">
          {navItems.map((item) => (
            <NavLink
              ...
              className={({ isActive }) =>
                `
                block px-4 py-2 rounded-xl font-medium no-underline!
      ...
      <div className="flex-1 flex flex-col">
        <main className="flex-1 overflow-y-auto p-4 bg-white/85 backdrop-blur-lg shadow-2xl transition-all duration-500">
          <Outlet />
        </main>
      </div>
